...
class Predator extends Bot{
    ...
    public Predator(){
        ...
        r = 100 + (150 - 100) * rNumber.nextDouble();
        this.setFovLength(r);

        r = 30 + (60 - 30) * rNumber.nextDouble();
        this.setFov(r);
    ...
    public double getFitness() {
        ...
        _fitness = this.getTurnSpeed() + this.getFov() + this.getFovLength() + this.getSpeed();
        ...
        if(this.getEnergy() >= 300){
            _fitness += 10;
        }
        
        if(this.getEnergy() >= 400){
            _fitness += 10;
        }
