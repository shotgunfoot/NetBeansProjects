...
public class Bot implements Runnable{
    ...
    Bot(){
        //System.out.println("Generic bot constructor");
    }
    
    public void run(){
        System.out.println("Generic Bot created");
    }
...
class Prey extends Bot{
    ...
    */
    Prey(){
        ...
        r = 1.0 + (2.0 - 1.0) * rNumber.nextDouble();
        this.setTurnSpeed(r);
        System.out.println("Prey constructor done");
    }
    
    public void run(){
        System.out.println("Prey bot created");
    }
}